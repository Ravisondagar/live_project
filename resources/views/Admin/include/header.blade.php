			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="{{ route('change-password-form') }}"><i class="fa fa-cog" aria-hidden="true"></i>Change Password</a>
						...
						{{-- {!! former::open()->method('post')->action( URL::route("logout",Auth::user()->id) )->id('form') !!}
						{!! former::close() !!} --}}
					</div>
				</div>
			</div>
